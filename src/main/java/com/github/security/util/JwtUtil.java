...
public class JwtUtil {
     ...
     * @return 令牌
     */
    public static String generateToken(Tuser userDetail) {
     ...
     * @return 用户名
     */
    public Tuser getUserFromToken(HttpServletRequest request) {
        // 获取请求携带的令牌
        ...
        if (StringUtils.isNotEmpty(token)) {
            ...
            if (validateToken(token, username)){
                // 未把密码放到jwt
                return new Tuser(userId,username,"",authorities);
            }
        }
        return null;
    }
